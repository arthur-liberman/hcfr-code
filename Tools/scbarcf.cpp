...
void CSizingControlBarCF::NcPaintGripper(CDC* pDC, CRect rcClient)
{
    ...
    COLORREF clrCptn = m_bActive ?
        FxGetSysColor(COLOR_ACTIVECAPTION) :
        FxGetSysColor(COLOR_INACTIVECAPTION);

	// Fx mod: always active
//	clrCptn = DarkenColor(FxGetSysColor(COLOR_ACTIVECAPTION);
	// End of fx mod
    ...
    else
    {
        ...
        COLORREF clrCptnRight = m_bActive ?
            FxGetSysColor(COLOR_GRADIENTACTIVECAPTION) :
            FxGetSysColor(COLOR_GRADIENTINACTIVECAPTION);
    ...
    if (bFont)
    {
        ...
        COLORREF clrCptnText = m_bActive ?
            FxGetSysColor(COLOR_CAPTIONTEXT) :
            FxGetSysColor(COLOR_INACTIVECAPTIONTEXT);
