...
//	CCIEGraphPoint colorTempPoint3500(0.4075,0.3962,100.0,Msg+" 3500", m_bCIEuv);   
	...
	if(m_doShowSaturationScaleTarg) 
	{
		...
		for(int i=0;i<pDoc->GetMeasure()->GetSaturationSize();i++)
		{
			...
			CCIEGraphPoint RedPointRef(pDoc->GetMeasure()->GetRefSat(0, (double)i / (double)(pDoc->GetMeasure()->GetSaturationSize()-1), true).GetXYZValue(),
								  YWhite,
								  str, m_bCIEuv);
			DrawAlphaBitmap(pDC,RedPointRef,&m_redSatRefBitmap,rect,pTooltip,pWnd);
			Msg.LoadString ( IDS_GREENSATPERCENTREF );
			str.Format(Msg, (i*100/(pDoc->GetMeasure()->GetSaturationSize()-1)));
			CCIEGraphPoint GreenPointRef(pDoc->GetMeasure()->GetRefSat(1, (double)i / (double)(pDoc->GetMeasure()->GetSaturationSize()-1), true).GetXYZValue(),
								  YWhite,
								  str, m_bCIEuv);
			DrawAlphaBitmap(pDC,GreenPointRef,&m_greenSatRefBitmap,rect,pTooltip,pWnd);
						Msg.LoadString ( IDS_BLUESATPERCENTREF );
			str.Format(Msg, (i*100/(pDoc->GetMeasure()->GetSaturationSize()-1)));
			CCIEGraphPoint BluePointRef(pDoc->GetMeasure()->GetRefSat(2, (double)i / (double)(pDoc->GetMeasure()->GetSaturationSize()-1), true).GetXYZValue(),
								  YWhite,
								  str, m_bCIEuv);
			DrawAlphaBitmap(pDC,BluePointRef,&m_blueSatRefBitmap,rect,pTooltip,pWnd);
			Msg.LoadString ( IDS_YELLOWSATPERCENTREF );
			str.Format(Msg, (i*100/(pDoc->GetMeasure()->GetSaturationSize()-1)));
			CCIEGraphPoint YellowPointRef(pDoc->GetMeasure()->GetRefSat(3, (double)i / (double)(pDoc->GetMeasure()->GetSaturationSize()-1), true).GetXYZValue(),
								  YWhite,
								  str, m_bCIEuv);
			DrawAlphaBitmap(pDC,YellowPointRef,&m_yellowSatRefBitmap,rect,pTooltip,pWnd);
			Msg.LoadString ( IDS_CYANSATPERCENTREF );
			str.Format(Msg, (i*100/(pDoc->GetMeasure()->GetSaturationSize()-1)));
			CCIEGraphPoint CyanPointRef(pDoc->GetMeasure()->GetRefSat(4, (double)i / (double)(pDoc->GetMeasure()->GetSaturationSize()-1), true).GetXYZValue(),
								  YWhite,
								  str, m_bCIEuv);
			DrawAlphaBitmap(pDC,CyanPointRef,&m_cyanSatRefBitmap,rect,pTooltip,pWnd);
			Msg.LoadString ( IDS_MAGENTASATPERCENTREF );
			str.Format(Msg, (i*100/(pDoc->GetMeasure()->GetSaturationSize()-1)));
			CCIEGraphPoint MagentaPointRef(pDoc->GetMeasure()->GetRefSat(5, (double)i / (double)(pDoc->GetMeasure()->GetSaturationSize()-1), true).GetXYZValue(),
								  YWhite,
								  str, m_bCIEuv);
	...
	if(m_doShowCCScaleTarg) 
	{
        ...
        if (GetConfig()->m_CCMode != CCSG && GetConfig()->m_CCMode != USER)
        {
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_2a:(GetConfig()->m_CCMode == SKIN?IDS_CC_2b:IDS_CC_2) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_3a:(GetConfig()->m_CCMode == SKIN?IDS_CC_3b:IDS_CC_3) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_4a:(GetConfig()->m_CCMode == SKIN?IDS_CC_4b:IDS_CC_4) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_5a:(GetConfig()->m_CCMode == SKIN?IDS_CC_5b:IDS_CC_5) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_6a:(GetConfig()->m_CCMode == SKIN?IDS_CC_6b:IDS_CC_6) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_7a:(GetConfig()->m_CCMode == SKIN?IDS_CC_7b:IDS_CC_7) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_8a:(GetConfig()->m_CCMode == SKIN?IDS_CC_8b:IDS_CC_8) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_9a:(GetConfig()->m_CCMode == SKIN?IDS_CC_9b:IDS_CC_9) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_10a:(GetConfig()->m_CCMode == SKIN?IDS_CC_10b:IDS_CC_10) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_11a:(GetConfig()->m_CCMode == SKIN?IDS_CC_11b:IDS_CC_11) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_12a:(GetConfig()->m_CCMode == SKIN?IDS_CC_12b:IDS_CC_12) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_13a:(GetConfig()->m_CCMode == SKIN?IDS_CC_13b:IDS_CC_13) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_14a:(GetConfig()->m_CCMode == SKIN?IDS_CC_14b:IDS_CC_14) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_15a:(GetConfig()->m_CCMode == SKIN?IDS_CC_15b:IDS_CC_15) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_16a:(GetConfig()->m_CCMode == SKIN?IDS_CC_16b:IDS_CC_16) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_17a:(GetConfig()->m_CCMode == SKIN?IDS_CC_17b:IDS_CC_17) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_18a:(GetConfig()->m_CCMode == SKIN?IDS_CC_18b:IDS_CC_18) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_19a:(GetConfig()->m_CCMode == SKIN?IDS_CC_19b:IDS_CC_19) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_20a:(GetConfig()->m_CCMode == SKIN?IDS_CC_20b:IDS_CC_20) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_21a:(GetConfig()->m_CCMode == SKIN?IDS_CC_21b:IDS_CC_21) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_22a:(GetConfig()->m_CCMode == SKIN?IDS_CC_22b:IDS_CC_22) );
			str.Format(Msg, 10);			
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_23a:(GetConfig()->m_CCMode == SKIN?IDS_CC_23b:IDS_CC_23) );
			str.Format(Msg, 10);
			...
			Msg.LoadString ( GetConfig()->m_CCMode == AXIS?IDS_CC_24a:(GetConfig()->m_CCMode == SKIN?IDS_CC_24b:IDS_CC_24) );
			str.Format(Msg, 10);
